...
const StandardPlan = () => {
    return (
      ...
      <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-[#058f1a] rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-[#058f1a] dark:text-white">
