            ...
            <div className="px-3 py-3 lg:px-5 lg:pl-3">
                <div className="flex items-center justify-between">
                    <div className="flex items-center justify-start">
                        <button id="toggleSidebarMobile" aria-expanded="true" aria-controls="sidebar" className="p-2 text-gray-900 rounded cursor-pointer lg:hidden hover:text-white hover:bg-[#058f1a] focus:bg-[#058f1a] focus:text-white">
                        ...
                        <Image src={Logo} width={130} height={50} alt='logo' className='md:ml-0 ml-10' />
                    ...
                    <div className="flex items-center">
                        <button id="toggleSidebarMobileSearch" type="button" className="p-2 text-gray-900 rounded-lg lg:hidden hover:text-white hover:bg-[#058f1a]">
