  ...
  return (
    <div className='flex items-center justify-center flex-col p-6'>
      <div className='flex items-center max-w-full mb-4 text-3xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-4xl dark:text-white mt-16'>
        <h1 className='max-w-[45rem] mr-32'>🌻 - Essential Tools for Modern Farmers and Top-Quality Farming Equipment for Every Need.</h1>
        <div className='h-1 w-1 bg-gray-300 mx-4'></div>
